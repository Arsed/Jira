...
import de.test.automatedTests.managers.ColumnsManager;
import de.test.automatedTests.managers.IssueManager;
...
public class AbstractAcceptanceTest extends AbstractTestNGSpringContextTests {
    ...
    protected ColumnsManager ColumnManager;
    protected IssueManager IssuesMananger;
    ...
    public void openApplication() {
        ...
        ColumnManager = new ColumnsManager(driver);
        IssuesMananger=new IssueManager(driver);

        logger.info("Opening application " + applicationURL);
        driver.get(applicationURL);

        new WebDriverWait(driver, ApplicationManager.WAIT_TIME_OUT_IN_SECONDS).until(ExpectedConditions.elementToBeClickable(By.cssSelector("#addColBtn")));
    }
